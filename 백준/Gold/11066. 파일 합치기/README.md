...
이 유형쪽에서 상당히 교육적인 것 같습니다.

### 풀이

아주 전형적인 DP 문제입니다.
전형적인 DP 문제가 으레 그렇지만, 형태 자체는 [11049. 행렬 곱셈 순서](/백준/Gold/11049.%20행렬%20곱셈%20순서) 문제와 유사합니다.
자세한 풀이는 상기 문제에 적어두었습니다.

다만, 특정 범위의 파일 길이 총합이 매번 필요한데, 누적합을 쓰면 쉽게 구할 수 있습니다.
